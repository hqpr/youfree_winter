...
<body>
    ...
    <div class="quiz">
        ...
        <div class="question">
            Какая страна стала лидером апре-ски вечеринок?
        </div>
            <div class="answers">
                <div id="answer1">2 человек</div>
                <div id="answer2">24 человека</div>
                <div id="answer3">100 человек</div>
            </div>
        ...
        <div class="next">
            <a href="/game/results.php"><img src="/images/next.png" alt=""/></a>
        </div>
