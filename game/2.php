...
<body>
    ...
    <div class="quiz two">
        ...
        <div class="question">
            Что изобрели раньше — сани или колесо?
        </div>
            <div class="answers">
                <div id="answer1">Синий</div>
                <div id="answer2">Розовый</div>
                <div id="answer3">Фиолетовый</div>
            </div>
        ...
        <div class="next">
            <a href="/game/3.php"><img src="/images/next.png" alt=""/></a>
        </div>
