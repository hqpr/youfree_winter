...
<body>
    ...
    <div class="quiz one">
        ...
        <div class="question">
            Сколько стоят самые дорогие в мире санки?
        </div>
            <div class="answers">
                <div id="answer1">около 2500 евро</div>
                <div id="answer2">3750 евро</div>
                <div id="answer3">более 7000 евро</div>
            </div>
        ...
        <div class="next">
            <a href="/game/2.php"><img src="/images/next.png" alt=""/></a>
        </div>
