...
<body>
    ...
    <div class="quiz five">
        ...
        <div class="question">
            Сколько человек приняло участие в самом масштабном снежном батле?
        </div>
            <div class="answers">
                <div id="answer1">В космосе</div>
                <div id="answer2">Под водой</div>
                <div id="answer3">В невесомости</div>
            </div>
        ...
        <div class="next">
            <a href="/game/6.php"><img src="/images/next.png" alt=""/></a>
        </div>
