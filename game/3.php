...
<body>
    ...
    <div class="quiz three">
        ...
        <div class="question">
            Как называются управляемые сани?
        </div>
            <div class="answers">
                <div id="answer1">Корабля</div>
                <div id="answer2">Отвесной скалы</div>
                <div id="answer3">Дерева</div>
            </div>
        ...
        <div class="next">
            <a href="/game/4.php"><img src="/images/next.png" alt=""/></a>
        </div>
