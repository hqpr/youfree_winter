...
<body>
    ...
    <div class="quiz four">
        ...
        <div class="question">
            В какой стране слепили самый большой снежок в мире?
        </div>
            <div class="answers">
                <div id="answer1" style="font-size: 24px">Высоте, с которой прыгает спортсмен</div>
                <div id="answer2">Входу в воду без брызг</div>
                <div id="answer3" style="font-size: 21px">Количеству исполненных в воздухе трюков</div>
            </div>
        ...
        <div class="next">
            <a href="/game/5.php"><img src="/images/next.png" alt=""/></a>
        </div>
                ...
                $('.confirm').css("visibility", "visible").click(function(){
                    function results(){
                        if ($('#answer2').hasClass('selected')) {
                            $('#answer2').removeClass('selected').addClass('correct');
                            ...
                            $('#answer2').removeClass('selected').addClass('correct_was');
                        }
                    }
                    results();
